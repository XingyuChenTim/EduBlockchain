...
WebUI.click(findTestObject('Object Repository/Project/Check transaction poll/Page_User page/a_Check Transaction'))
...
WebUI.click(findTestObject('Object Repository/Project/Check transaction poll/Page_User page/a_Sign Out(current)'))
