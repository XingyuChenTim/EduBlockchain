...
WebUI.click(findTestObject('Object Repository/Project/Broadcast a request/Page_Signin/button_Sign in'))

WebUI.click(findTestObject('Object Repository/Project/Broadcast a request/Page_User page/a_Send tokens'))
...
WebUI.click(findTestObject('Object Repository/Project/Broadcast a request/Page_Broadcast/input_Hash ID_hashid'))
...
WebUI.click(findTestObject('Object Repository/Project/Broadcast a request/Page_User page/a_Sign Out(current)'))
